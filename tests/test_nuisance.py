...
from insurance_autodml._nuisance import (
    SklearnNuisance,
    build_nuisance_model,
    _build_DX,
)
from insurance_autodml._types import OutcomeFamily
...
class TestBuildNuisanceModel:
    ...
    def test_linear_backend(self):
        from insurance_autodml._nuisance import SklearnNuisance
    ...
    def test_catboost_unavailable_raises(self):
        ...
        try:
            ...
            from insurance_autodml._nuisance import CatBoostNuisance
            m = CatBoostNuisance()
