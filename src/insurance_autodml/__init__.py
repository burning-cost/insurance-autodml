...
The central problem this library solves: you have a continuous treatment
...
from insurance_autodml.dgp import SyntheticContinuousDGP
from insurance_autodml.elasticity import PremiumElasticity
from insurance_autodml.dose_response import DoseResponseCurve
from insurance_autodml.policy_shift import PolicyShiftEffect
from insurance_autodml.selection import SelectionCorrectedElasticity
from insurance_autodml.report import ElasticityReport
from insurance_autodml.riesz import ForestRiesz, LinearRiesz
from insurance_autodml._types import (
    EstimationResult,
    SegmentResult,
    DoseResponseResult,
    OutcomeFamily,
